...
from book_code.chapter_08.slim import slim

FLAGS = tf.app.flags.FLAGS

tf.app.flags.DEFINE_string('train_dir', os.path.realpath('../../datasets/DR/checkpoints/299_1'),
...
tf.app.flags.DEFINE_string('pretrained_model_checkpoint_path',
                           os.path.realpath('../../datasets/DR/checkpoints/pre_trained/inception-v3/model.ckpt-157585'),
